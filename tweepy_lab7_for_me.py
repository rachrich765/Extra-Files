...
import twitter_info_me		# you need to initialize this file with your Tweet app info

# Fill these in in the twitter_info.py file
consumer_key = twitter_info_me.consumer_key
consumer_secret = twitter_info_me.consumer_secret
access_token = twitter_info_me.access_token
access_token_secret = twitter_info_me.access_token_secret
